...
export class DataTransformationEngine {
  ...
  createPipeline(
    ...
    logger.info("Transformation pipeline created", "data-transformation", {
      pipelineId: id,
  ...
  updatePipeline(
    ...
    logger.info("Transformation pipeline updated", "data-transformation", {
      pipelineId: id,
      updates,
    });
  ...
  deletePipeline(id: string): boolean {
    ...
    if (deleted) {
      logger.info("Transformation pipeline deleted", "data-transformation", {
        pipelineId: id,
      });
    }
  ...
  addStep(
    ...
    logger.info("Transformation step added", {
  ...
  updateStep(
    ...
    logger.info("Transformation step updated", {
      category: "data-transformation",
      pipelineId,
      stepId,
      updates,
  ...
  removeStep(pipelineId: string, stepId: string): boolean {
    ...
    if (deleted) {
      logger.info("Transformation step removed", {
        category: "data-transformation",
        pipelineId,
        stepId,
      });
  ...
  reorderSteps(pipelineId: string, stepIds: string[]): boolean {
    ...
    logger.info("Transformation steps reordered", {
      category: "data-transformation",
      pipelineId,
      newOrder: stepIds,
    });

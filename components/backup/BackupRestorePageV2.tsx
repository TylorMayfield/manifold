...
interface BackupRestorePageV2Props {
  project?: Project | null;
  dataSources?: DataSource[];
  onRestore?: (result: RestoreResult) => void;
}

type TabType = "backup" | "restore" | "jobs" | "settings";

export default function BackupRestorePageV2({
  project,
  dataSources = [],
  onRestore,
}: BackupRestorePageV2Props) {
        ...
        <div className="max-w-7xl mx-auto p-8 space-y-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 bg-dark_cyan-300/10 rounded-xl p-1 backdrop-blur-sm">
              {[
                ...
                { id: "jobs", label: "Job Status", icon: Calendar },
          ...
          <div className="space-y-8 mt-8">
            ...
            {activeTab === "jobs" && (
              <div className="glass-card p-8 hover:bg-dark_cyan-300 hover:bg-opacity-25 transition-all duration-200">
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 rounded-xl bg-dark_cyan-500/20 backdrop-blur-sm">
                    <Calendar className="h-7 w-7 text-dark_cyan-400" />
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-white">
                      Backup Jobs
                    ...
                    <p className="text-sm text-dark_cyan-400">
                      Monitor backup job progress and status
                    </p>
                  </div>
                </div>

                <div className="text-center py-12">
                  <Calendar className="h-16 w-16 text-dark_cyan-400 mx-auto mb-4" />
                  <h4 className="text-lg font-medium text-white mb-2">
                    Job Monitoring
                  </h4>
                  <p className="text-dark_cyan-400 max-w-sm mx-auto">
                    Job monitoring functionality will be implemented in the next
                    update.
                  </p>
                </div>
              </div>
